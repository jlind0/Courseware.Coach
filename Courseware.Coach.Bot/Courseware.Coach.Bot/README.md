...
- In a terminal, navigate to `Courseware.Coach.Bot`

    ```bash
    # change into project folder
    cd Courseware.Coach.Bot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Courseware.Coach.Bot` folder
  - Select `Courseware.Coach.Bot.csproj` file
